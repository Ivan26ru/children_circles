<div class="block_training_with_us">
	<div class="wrap">
		...
		<div class="bltwu_block_2">
			<div class="bltwu_block_2_table"><?php echo do_shortcode(get_field('training_with_us_table', 'option')); ?></div>
			<div class="bltwu_block_2_cf7"><?php echo do_shortcode(get_field('training_with_us_cf7', 'option')); ?></div>
		</div>
	</div>
</div>