				...
				<div class="bc_wrap">
					...
					<div class="bc_content">
						...
						<div class="bcc_content">
							...
							<div class=""><img src="<?php echo get_template_directory_uri(); ?>/assets/img/bg_bom.png" alt=""></div>
				...
				<?php for ($i = 0; $i < 5; $i++) { ?>
					<div class="cg_item">
						<div class="cg_wrap_img">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/img/img_gratitude.png" alt="">
						</div>
					</div>
				<?php } ?>
			</div>
						...
						<?php for ($i2 = 0; $i2 < 2; $i2++) { ?>
							<div class="rar_item">
								<div class="rar_item_wrap_img">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/img/img_rar.png" alt="">
								</div>
				...
				<?php for ($i = 0; $i < 3; $i++) { ?>
					<div class="bso_item_card">
						<div class="bso_card_wrap_img">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/img/img_bso.png" alt="">
						</div>
					...
					<div class="bt_wrap_slider_item">
						<div class="bt_item">
							<div class="bt_avatar_wrap">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/img/bt_avatar.png" alt="">
							</div>
