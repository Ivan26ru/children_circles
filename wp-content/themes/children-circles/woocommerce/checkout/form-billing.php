...
?>
<div class="woo-block__wrap">

	<?php do_action('woocommerce_before_checkout_billing_form', $checkout); ?><?php
	$fields = $checkout->get_checkout_fields('billing');


	foreach ($fields as $key => $field) {
		//		echo get_vd($field);
		$field['class'][] = 'woo-block__item';
	...
	<div class="woocommerce-account-fields">
		...
		<?php if ($checkout->get_checkout_fields('account')) : ?>
			...
			<div class="create-account">
				<?php foreach ($checkout->get_checkout_fields('account') as $key => $field) : ?><?php woocommerce_form_field($key, $field, $checkout->get_value($key)); ?><?php endforeach; ?>
				<div class="clear"></div>
			</div>
